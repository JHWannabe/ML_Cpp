...
// -------------------------------------------------
// struct{CustomSequentialImpl}(nn::SequentialImpl)
// -------------------------------------------------
struct CustomSequentialImpl : nn::SequentialImpl {
    using nn::SequentialImpl::SequentialImpl;

    torch::Tensor forward(torch::Tensor x) {
        return nn::SequentialImpl::forward(x);
    }
};
...
public:
    ...
    YOLOv3Impl(mINI::INIStructure& ini);
